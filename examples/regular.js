...
(function() {
    ...
    var Regular = function(options) {
      ...
      if (this.$body) {
        this._getTransclude = function() {
          ...
          if (this.$body) return ctx.$compile(this.$body, {
  ...
  require.register("regularjs/src/walkers.js", function(exports, require, module) {
    ...
    walkers.template = function(ast, options) {
      ...
      var compiled, namespace = options.namespace,
        extra = options.extra;
      ...
      if (content) {
        ...
        this.$watch(content, function(value) {
          ...
          group.push(compiled = self.$compile(value, {
            record: true,
            outer: options.outer,
            namespace: namespace,
            extra: extra
    ...
    walkers['if'] = function(ast, options) {
      var self = this,
        consequent, alternate, extra = options.extra;
  ...
  require.register("regularjs/src/parser/Lexer.js", function(exports, require, module) {
    ...
    function setup(map) {
      ...
      function replaceFn(all, one) {
        return typeof macro[one] === 'string' ?
          _.escapeRegExp(macro[one]) : String(macro[one]).slice(1, -1);
      }
    ...
    var rules = {
      ...
      JST_LEAVE: [/{END}/, function(all) {
        if (this.markEnd === all && this.expression) return {
          type: this.markEnd,
          value: this.markEnd
        };
    ...
    module.exports = {
      expression: function(expr, simple) {
        ...
        if (typeof expr === 'string' && (expr = expr.trim())) {
          expr = exprCache.get(expr) || exprCache.set(expr, new Parser(expr, {
            mode: 2,
            expression: true
          }).expression())
        }
  ...
  require.register("regularjs/src/directive/animation.js", function(exports, require, module) {
    ...
    function processAnimate(element, value) {
      ...
      var composites = value.split(";"),
        composite, context = this,
        seeds = [],
        seed, destroies = [],
        destroy,
        command, param, current = 0,
        tmp, animator, self = this;
